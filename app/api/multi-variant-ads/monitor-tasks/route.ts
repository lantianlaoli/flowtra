...
export async function POST() {
  try {
    console.log('Starting multi-variant ads task monitoring...');
    ...
    console.log(`Multi-variant ads task monitoring completed: ${processed} processed, ${completed} completed, ${failed} failed`);
    ...
    return NextResponse.json({
      ...
      message: 'Multi-variant ads task monitoring completed'
    });

  } catch (error) {
    console.error('Multi-variant ads task monitoring error:', error);
    return NextResponse.json({
