...
> Screen user prompts against content policies before generating images or videos with your AI models.
...
<Card title="Screen a prompt" icon="shield-check" href="/api-reference/endpoint/screen-prompt">
...
<CardGroup cols={2}>
  <Card title="Screen a prompt — API Reference" icon="code" href="/api-reference/endpoint/screen-prompt">
