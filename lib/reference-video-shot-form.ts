...
export interface ReferenceVideoShotForm {
  shot_id: number;
  start_time: string;
  end_time: string;
...
export const parseShotsFromAnalysis = (analysisInput: unknown): ReferenceVideoShotForm[] => {
  ...
  const timeline = parseReferenceVideoTimeline(normalizedAnalysis);
...
export const sanitizeShotsForSave = (shots: ReferenceVideoShotForm[]): ReferenceVideoShotForm[] => {
...
export const createEmptyShot = (id: number): ReferenceVideoShotForm => ({
  shot_id: id,
  start_time: '00:00',
  end_time: '00:00',
  duration_seconds: 6,
...
export const reindexShots = (shots: ReferenceVideoShotForm[]): ReferenceVideoShotForm[] =>
