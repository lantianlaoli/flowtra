export const AVATAR_ADS_SIMULATION_SEQUENCE = [
  {
    status: 'pending',
    step: 'analyzing_images',
    progress: 0,
    message: 'Initializing avatar spokesperson workflow...'
  },
  {
  ...
  },
  {
    ...
    step: 'completed',
    progress: 100,
    message: 'Avatar spokesperson advertisement is ready to download.'
  }
] as const;
