...
export const onboardingSteps: OnboardingStep[] = [
  ...
  },
  {
    id: 'avatar-ads',
    title: 'Avatar Ads',
    description: 'Create avatar-based advertising content. Let virtual avatars promote your products, adding personality and engagement to your ads.',
    targetId: 'sidebar-avatar-ads',
    placement: 'right',
  },
  {
    id: 'my-ads',
    title: 'My Ads',
    description: 'View all your ad history including Competitor UGC Replication and avatar ads. Easily manage and download all your creations in one place.',
