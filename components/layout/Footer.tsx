          ...
          <div className="grid grid-cols-1 lg:grid-cols-[2fr_1fr_1fr_1fr_1fr] gap-8 lg:gap-12">
            ...
            <section aria-labelledby="footer-about">
              ...
              <Link href={process.env.NEXT_PUBLIC_SITE_URL || "/"} className="flex items-center gap-2 mb-4">
                <Image
                  ...
                  className=""
                />
                <span className="text-xl font-semibold text-gray-900">Flowtra <span className="italic">AI</span></span>
              </Link>
            ...
            <nav aria-labelledby="footer-features">
              ...
              <ul className="space-y-2.5">
                ...
                <li>
                  <Link href="/features/competitor-replica" className="text-sm text-gray-600 hover:text-gray-900 transition-colors">
                    Competitor Replica
                  </Link>
                </li>
              </ul>
            ...
            <nav aria-labelledby="footer-resources">
              <h3 id="footer-resources" className="text-sm font-semibold text-gray-900 mb-4">Resources</h3>
              <ul className="space-y-2.5">
                <li>
                ...
                <li>
                  <Link href="/sora2-watermark-removal" className="text-sm text-gray-600 hover:text-gray-900 transition-colors">
            ...
            <nav aria-labelledby="footer-contact">
              <h3 id="footer-contact" className="text-sm font-semibold text-gray-900 mb-4">Contact</h3>
              <ul className="space-y-2.5">
                <li>
                  <a
            ...
            <nav aria-labelledby="footer-legal">
              <h3 id="footer-legal" className="text-sm font-semibold text-gray-900 mb-4">Legal</h3>
              <ul className="space-y-2.5">
                <li>
