        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            ...
            <p className="text-gray-600 mb-4 max-w-md">
              AI-powered e-commerce advertisement generation. Transform your product photos into professional video ads and cover images in minutes.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li>
                <a href="mailto:support@flowtra.com" className="text-gray-600 hover:text-gray-900 transition-colors">
                  Help Center
                </a>
              </li>
              <li>
        ...
        <div className="border-t border-gray-200 mt-12 pt-8">
          <div className="flex flex-col md:flex-row items-center justify-between">
            <p className="text-gray-500 text-sm mb-4 md:mb-0">
              &copy; 2024 Flowtra. All rights reserved.
            </p>
            
            {/* Social Links */}
            <div className="flex items-center gap-6">
              <a 
                href="https://twitter.com/flowtra" 
                target="_blank" 
              ...
              <a 
                href="https://linkedin.com/company/flowtra" 
                target="_blank" 
                rel="noopener noreferrer"
                className="text-gray-400 hover:text-gray-600 transition-colors"
              >
