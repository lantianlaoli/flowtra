      ...
      offers: [
        {
          ...
          price: '29',
          priceCurrency: 'USD',
          description: '1,930 credits. Approximately 96 Veo3 Fast videos or 321 Sora2 videos. Includes Viral Clone, Avatar Ads, Motion Clone, plus free unlimited AI Agent access. Generation-time billing.',
        ...
        },
        {
          ...
          price: '59',
          priceCurrency: 'USD',
          description: '3,930 credits. Approximately 196 Veo3 Fast videos or 655 Sora2 videos. Image generation included. Includes Viral Clone, Avatar Ads, Motion Clone, plus free unlimited AI Agent access.',
          availability: 'https://schema.org/InStock',
          url: 'https://www.flowtra.store/#pricing',
          priceValidUntil: '2025-12-31',
          itemOffered: {
        ...
        },
        {
          ...
          price: '99',
          priceCurrency: 'USD',
          description: '6,600 credits. Approximately 330 Veo3 Fast videos or 1100 Sora2 videos. Priority processing, generation-time billing. Includes Viral Clone, Avatar Ads, Motion Clone, plus free unlimited AI Agent access.',
          availability: 'https://schema.org/InStock',
          url: 'https://www.flowtra.store/#pricing',
          priceValidUntil: '2025-12-31',
          itemOffered: {
