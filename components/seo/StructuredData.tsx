...
export default function StructuredData() {
  ...
  const productSchema = {
    ...
    description: 'Professional AI-powered video ad generator that creates high-converting advertisements from product images. Features Standard Ads, Multi-Variant Ads, and Character Ads workflows.',
    offers: {
      '@type': 'AggregateOffer',
      ...
      offers: [
        {
          ...
          price: '9',
          priceCurrency: 'USD',
          description: '500 credits. Approximately 25 Veo3 Fast videos. Includes Standard Ads, Multi-Variant Ads, and Character Ads. Mixed billing model with free image generation.',
        ...
        },
        {
          ...
          price: '29',
          priceCurrency: 'USD',
          description: '2,000 credits. Approximately 100 Veo3 Fast videos. Free unlimited downloads and image generation. Includes all features: Standard Ads, Multi-Variant Ads, Character Ads.',
          availability: 'https://schema.org/InStock',
          url: 'https://www.flowtra.store/#pricing',
          priceValidUntil: '2025-12-31',
          itemOffered: {
        ...
        },
        {
          ...
          price: '49',
          priceCurrency: 'USD',
          description: '3,500 credits. Approximately 175 Veo3 Fast videos. Priority processing, mixed billing model, free image generation. Includes Standard Ads, Multi-Variant Ads, and Character Ads.',
          availability: 'https://schema.org/InStock',
          url: 'https://www.flowtra.store/#pricing',
          priceValidUntil: '2025-12-31',
          itemOffered: {
    ...
    featureList: [
      'Standard Ads: Single product image to video conversion',
      'Multi-Variant Ads: Generate multiple video variants from one image',
