...
export default function SizeSelector({
  ...
  // Size options with detailed platform descriptions
  const sizeOptions = [
    {
      value: 'auto',
      label: 'Auto',
      subtitle: 'Native Resolution',
      description: 'Preserves original photo dimensions',
      platforms: 'Product showcases, e-commerce',
      icon: Square,
      ratio: null
    },
    {
    ...
    },
    {
      ...
      platforms: 'Instagram Stories preview, Facebook Feed',
      icon: Smartphone,
      ratio: '3:4'
    },
    {
    ...
    },
    {
      ...
      platforms: 'Facebook ads, desktop displays',
      icon: Monitor,
      ratio: '4:3'
    },
    {
      ...
      platforms: 'YouTube videos, banner ads',
      icon: Video,
      ratio: '16:9'
    }
  ];
