            ...
            <div className="flex items-center justify-between p-6 border-b border-gray-200">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-600">Upload character photo with a name</p>
                </div>
              </div>
              <button
                onClick={onClose}
                  ...
                  {avatarPreview ? (
                    ...
                    <label className="block">
                      <input
                        ...
                        disabled={isCreating}
                      />
                      <div className="w-full h-48 border-2 border-dashed border-gray-300 rounded-lg flex flex-col items-center justify-center hover:border-gray-400 cursor-pointer transition-colors">
