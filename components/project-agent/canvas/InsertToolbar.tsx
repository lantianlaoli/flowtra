          ...
          <div className="relative min-w-0 shrink" key={entry.key}>
            <button
              ...
              className={`project-agent-insert-trigger flex h-11 min-w-0 items-center rounded-[12px] border py-2 text-sm font-semibold transition-all duration-150 ${
                ...
                open
                  ? 'project-agent-insert-trigger--active border-[#111111] bg-[#111111] text-white shadow-[0_1px_0_rgba(255,255,255,0.08)_inset,0_3px_0_rgba(20,20,20,0.95),0_12px_20px_rgba(0,0,0,0.16)] hover:translate-y-[1px] hover:bg-[#1a1a1a] hover:shadow-[0_1px_0_rgba(255,255,255,0.08)_inset,0_2px_0_rgba(20,20,20,0.95),0_8px_14px_rgba(0,0,0,0.16)] active:translate-y-[3px] active:shadow-[0_1px_0_rgba(255,255,255,0.06)_inset,0_0px_0_rgba(20,20,20,0.9),0_4px_8px_rgba(0,0,0,0.12)]'
                  : 'border-[#cfcfcb] bg-white text-[#2a2a2a] shadow-[0_1px_0_rgba(255,255,255,0.95)_inset,0_3px_0_rgba(203,203,199,0.95),0_10px_18px_rgba(0,0,0,0.06)] hover:translate-y-[1px] hover:border-[#111111] hover:bg-[#f6f6f4] hover:shadow-[0_1px_0_rgba(255,255,255,0.95)_inset,0_2px_0_rgba(203,203,199,0.95),0_8px_14px_rgba(0,0,0,0.06)] active:translate-y-[3px] active:shadow-[0_1px_0_rgba(255,255,255,0.92)_inset,0_0px_0_rgba(203,203,199,0.88),0_4px_8px_rgba(0,0,0,0.05)]'
              }`}
