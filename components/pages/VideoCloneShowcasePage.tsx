...
export default function VideoCloneShowcasePage() {
  // Example cases data
  const examples = [
    {
      id: 1,
      productImage: `${SITE_ASSET_BASE_URL}/showcase/shared/images/video_clone_1_product.jpg`,
      videoUrl: `/showcase/video-clone/reference-source.mp4`,
    },
    {
      id: 2,
      productImage: `${SITE_ASSET_BASE_URL}/showcase/shared/images/video_clone_2_product.png`,
      videoUrl: `/showcase/video-clone/reference-result.mp4`,
    },
  ];
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 lg:py-24">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="flex justify-center lg:justify-end">
            <div className="w-full max-w-[605px] overflow-hidden rounded-[24px] border border-gray-200 bg-black shadow-[0_18px_40px_rgba(0,0,0,0.06)]">
      ...
      <section className="bg-gray-50 py-16 lg:py-24">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-3xl mx-auto mb-12">
            ...
            <p className="text-lg text-gray-600">
              Video Clone works great for various businesses and platforms
            </p>
          </div>
