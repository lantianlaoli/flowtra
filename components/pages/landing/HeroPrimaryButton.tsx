  ...
  if (user) {
    return (
      <button
        ...
        className="bg-black text-white h-14 px-8 rounded-lg text-lg font-semibold flex items-center gap-2 flex-1 justify-center cursor-pointer transition-colors duration-200 hover:bg-[#333333]"
      >
        <Copy className="w-5 h-5" />
