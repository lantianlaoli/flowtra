...
export default function LiteTrialCtaSection() {
  ...
  return (
    <section className="px-4 py-12 md:px-6 md:py-16">
      <div className="mx-auto grid max-w-6xl items-center gap-8 overflow-hidden rounded-[32px] border border-[#E7E7E7] bg-[#F7F7F7] p-6 shadow-[0_18px_40px_rgba(0,0,0,0.04)] md:grid-cols-[0.95fr_1.05fr] md:p-8 lg:p-10">
        <div>
          <p className="mb-3 text-[12px] font-bold uppercase tracking-[0.18em] text-[#666666]">{copy.eyebrow}</p>
          <h2 className="max-w-xl text-[28px] font-bold tracking-tight text-black md:text-[34px]">{copy.title}</h2>
          <p className="mt-4 max-w-lg text-base leading-7 text-[#666666]">{copy.description}</p>
